...
\begin{figure}[H] \centering{
			\caption{Project Initiation Document}
		\includegraphics[scale=0.80]{PID.pdf}}
\end{figure}

\newpage
\includepdf[pages={2-}]{PID}
...
\begin{figure}[H] \centering{
		\label{code}
		\caption{Code definitions}
		\includegraphics[scale=0.80]{codedef.pdf}}
\end{figure}

\newpage
\includepdf[pages={2-}, scale =.8]{codedef}

\newpage
\clearpage
\begin{figure}[H] \centering{
		\label{sound}
		\caption{Sound implementation details}
		\includegraphics[scale=0.80]{sound.pdf}}
\end{figure}

\newpage
\includepdf[pages={2-}, scale =.8]{sound}
